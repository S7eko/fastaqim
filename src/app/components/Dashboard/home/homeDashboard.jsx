...
const HomeDashboard = () => {
  ...
  return (
    <div className="flex min-h-screen bg-[var(--background)] text-[var(--foreground)] pt-[73px]">
      {/* Sidebar */}
      <div className="w-72 bg-gradient-to-b from-green-700 to-green-800 dark:from-gray-800 dark:to-gray-900 shadow-xl sticky top-[73px] h-[calc(100vh-73px)] flex flex-col">
        <div className="p-5 border-b border-green-600 dark:border-gray-700 flex flex-col items-center">
              ...
              <li key={action.id}>
                <button
                  ...
                  className={`w-full flex items-center gap-3 p-3 rounded-lg transition-all duration-200 ${selectedAction === action.id
                    ? "bg-[var(--card)] text-[var(--card-foreground)] font-semibold shadow-md"
        ...
        {/* Footer */}
        <div className="p-4 border-t border-green-600 dark:border-gray-700 text-white/80 text-sm text-center">
      ...
      <div className="flex-1 overflow-auto px-6 py-6">
        <main className="bg-[var(--card)] text-[var(--card-foreground)] rounded-xl shadow-sm p-6 min-h-[calc(100vh-120px)]">
          {!selectedAction && (
            <div>
              ...
              <div className="bg-[var(--background)] p-6 rounded-lg border border-gray-200 dark:border-gray-700">
                <h3 className="text-xl font-semibold mb-4">أحدث النشاطات</h3>
                <div className="space-y-4">
                  <div className="flex items-start gap-4 p-3 hover:bg-[var(--card)] rounded-lg transition">
                    <div className="bg-green-100 p-2 rounded-full text-green-700">
                      <FontAwesomeIcon icon={faQuran} />
                    </div>
                    <div className="flex-1">
                      <h4 className="font-medium">تمت إضافة جلسة جديدة</h4>
                      <p className="text-sm">جلسة مراجعة سورة البقرة</p>
                      <p className="text-xs opacity-70 mt-1">منذ يومين</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4 p-3 hover:bg-[var(--card)] rounded-lg transition">
                    ...
                    <div className="flex-1">
                      <h4 className="font-medium">طالب جديد</h4>
                      <p className="text-sm">محمد أحمد سجل في دورة التجويد</p>
                      <p className="text-xs opacity-70 mt-1">منذ 3 أيام</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4 p-3 hover:bg-[var(--card)] rounded-lg transition">
                    ...
                    <div className="flex-1">
                      <h4 className="font-medium">تقدم في الحفظ</h4>
                      <p className="text-sm">3 طلاب أكملوا حفظ جزء عم</p>
                      <p className="text-xs opacity-70 mt-1">منذ أسبوع</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-6">
            ...
            {selectedAction === "approve" && (
              <div className="bg-[var(--background)] p-6 rounded-lg border border-gray-200 dark:border-gray-700">
                <h3 className="text-xl font-semibold mb-4">قبول الطلاب</h3>
                <p>قائمة بطلبات التسجيل الجديدة للمراجعة...</p>
              </div>
            )}
          </div>
        </main>
