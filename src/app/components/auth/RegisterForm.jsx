...
const RegisterForm = () => {
  ...
  const validateForm = () => {
    ...
    if (password !== passwordConfirmation) newErrors.passwordConfirmation = 'كلمات المرور غير متطابقة';
    setErrors(newErrors);
      ...
      <div className="w-full max-w-md mx-auto">
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg p-6 sm:p-8 md:p-10 border border-green-100">
          <div className="text-center mb-8">
            ...
            />
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800 font-tajawal">إنشاء حساب جديد</h1>
            <p className="text-gray-600 mt-2 font-scheherazade">املأ النموذج لإنشاء حسابك</p>
          </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                  <FontAwesomeIcon icon={faIdCard} className="text-green-500 text-opacity-70" />
                </div>
                <input
                  id="name"
                  name="name"
                  ...
                  className={`block w-full pr-10 pl-3 py-2.5 text-sm border ${errors.name ? 'border-red-300 focus:ring-red-200' : 'border-gray-300 focus:ring-green-200'} rounded-lg focus:ring-2 focus:outline-none transition duration-200`}
                  placeholder="الاسم الكامل"
                />
              </div>
              {errors.name && <p className="mt-1 text-xs text-red-500 text-right">{errors.name}</p>}
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`block w-full pr-10 pl-3 py-2.5 text-sm border ${errors.passwordConfirmation ? 'border-red-300 focus:ring-red-200' : 'border-gray-300 focus:ring-green-200'} rounded-lg focus:ring-2 focus:outline-none transition duration-200`}
                  placeholder="••••••••"
                  dir="ltr"
                />
              </div>
              {errors.passwordConfirmation && <p className="mt-1 text-xs text-red-500 text-right">{errors.passwordConfirmation}</p>}
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-xs sm:text-sm text-gray-500">
              لديك حساب بالفعل؟{' '}
              <Link href="/apprefrance/auth/login" className="font-medium text-green-600 hover:text-green-500 transition-colors">
                <FontAwesomeIcon
                  icon={faSignInAlt}
                  className="ml-1"
                />
